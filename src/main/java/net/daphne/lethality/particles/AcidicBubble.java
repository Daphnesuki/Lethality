...
public class AcidicBubble extends TextureSheetParticle {
    protected AcidicBubble(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            AcidicBubble particle = new AcidicBubble(level, x, y, z, xSpeed, ySpeed, zSpeed);
