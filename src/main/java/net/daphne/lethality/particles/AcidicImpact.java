...
public class AcidicImpact extends TextureSheetParticle {
    protected AcidicImpact(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            AcidicImpact particle = new AcidicImpact(level, x, y, z, xSpeed, ySpeed, zSpeed);
