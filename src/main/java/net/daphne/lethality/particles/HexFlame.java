...
public class HexFlame extends TextureSheetParticle {
    protected HexFlame(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            HexFlame particle = new HexFlame(level, x, y, z, xSpeed, ySpeed, zSpeed);
