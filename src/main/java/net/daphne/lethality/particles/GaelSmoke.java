...
public class GaelSmoke extends TextureSheetParticle {
    protected GaelSmoke(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            GaelSmoke particle = new GaelSmoke(level, x, y, z, xSpeed, ySpeed, zSpeed);
