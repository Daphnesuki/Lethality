...
public class DevilsScytheEntity extends AbstractHurtingProjectile implements GeoEntity {
    ...
    public DevilsScytheEntity(EntityType<? extends DevilsScytheEntity> type, Level world) {
        super(type, world);
    }

    public DevilsScytheEntity(Level world, double x, double y, double z, float Damage) {
        this(ModEntities.DEVILS_SCYTHE.get(), world);
        this.setPos(x, y, z);
            ...
            for (int i = 0; i < (int)particleNum; ++i) {
                ...
                for (LivingEntity target : hitEntities) {
                    ...
                    if (!this.messagedEntities.contains(uuid)) {
                        ...
                        target.addEffect(new MobEffectInstance(TerramityModMobEffects.NYXIUM_FIRE.get(), 300, 2), this.getOwner());
