...
public class MateDulceItem extends Item {
    public MateDulceItem() {
        super(new Properties()
                .food(ModFoods.MATE_DULCE)
                .stacksTo(1));
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.lethality.mate_dulce.tooltip"));

        pTooltipComponents.add(Component.literal(" "));

        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("tooltip.lethality.mate_dulce.advanced1"));
            pTooltipComponents.add(Component.translatable("tooltip.lethality.mate_dulce.advanced2"));
            pTooltipComponents.add(Component.literal(" "));
        } else {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player player) {
            ...
            player.getFoodData().eat(6, 0.5F); // Ejemplo
            player.addEffect(new MobEffectInstance(ModMobEffects.TRANQUILITY.get(), 160));
