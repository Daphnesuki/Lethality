...
public class ViolenceItem extends SwordItem {
    public ViolenceItem(Properties pProperties) {
        super(ModToolTiers.CALAMITAS, 17, -2.4f, new Properties());
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.lethality.violence.tooltip"));

        pTooltipComponents.add(Component.literal(" "));

        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("tooltip.lethality.violence.advanced1"));
            pTooltipComponents.add(Component.translatable("tooltip.lethality.violence.advanced2"));
            pTooltipComponents.add(Component.translatable("tooltip.lethality.violence.advanced3"));
        } else {
