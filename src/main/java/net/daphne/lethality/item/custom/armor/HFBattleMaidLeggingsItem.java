...
public class HFBattleMaidLeggingsItem extends ArmorItem {
    public HFBattleMaidLeggingsItem(ArmorMaterial material, Type type, Properties properties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.lethality.hf_bm_leggings.tooltip"));
