...
public class BattleMaidChestplateItem extends ArmorItem {
    public BattleMaidChestplateItem(ArmorMaterial material, Type type, Properties properties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.lethality.bm_chestplate.tooltip"));
