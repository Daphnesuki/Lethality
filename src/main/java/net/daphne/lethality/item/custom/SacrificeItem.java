...
public class SacrificeItem extends SwordItem {
    public SacrificeItem(Properties pProperties) {
        super(ModToolTiers.CALAMITAS, 11, -1.4f, new Properties());
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.lethality.sacrifice.tooltip"));

        pTooltipComponents.add(Component.literal(" "));

        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("tooltip.lethality.sacrifice.advanced1"));
            pTooltipComponents.add(Component.translatable("tooltip.lethality.sacrifice.advanced2"));
            pTooltipComponents.add(Component.translatable("tooltip.lethality.sacrifice.advanced3"));
            pTooltipComponents.add(Component.translatable("tooltip.lethality.sacrifice.advanced4"));
        } else {
    ...
    public boolean hurtEnemy(ItemStack pStack, LivingEntity pTarget, LivingEntity pAttacker) {
        ...
        int currentAmplifier2 = 1;

        // Acumulación de STAINED_CALAMITY
        if (pTarget.hasEffect(ModMobEffects.STAINED_CALAMITY.get())) {
            currentAmplifier2 = pTarget.getEffect(ModMobEffects.STAINED_CALAMITY.get()).getAmplifier() + 2;
        }
