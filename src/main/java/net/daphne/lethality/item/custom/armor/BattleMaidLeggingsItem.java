...
public class BattleMaidLeggingsItem extends ArmorItem {
    public BattleMaidLeggingsItem(ArmorMaterial material, Type type, Properties properties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.lethality.bm_leggings.tooltip"));
